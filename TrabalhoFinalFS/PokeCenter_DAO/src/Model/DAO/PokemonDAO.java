...
public class PokemonDAO {
    ...
    public void inserir(Pokemon pokemon) throws SQLException {
        String sql = "INSERT INTO pokemons (nome, tipo_primario, tipo_secundario, nivel, hp_maximo, fk_treinador) VALUES (?,?, ?, ?, ?, ?)";
        try (Connection conn = ConexaoPostgresDB.conectar();
            ...
            stmt.setInt(6, pokemon.getFk_Treinador());
    ...
    public void inserirListaPokemons(List<Pokemon> listaPokemon) throws SQLException {
        ...
        for(int i = 0; i < listaPokemon.size(); i++){
            ...
            stmt.setInt(6, meuPokemon.getFk_Treinador());
    ...
    public void atualizar(Pokemon pokemon) throws SQLException {
        String sql = "UPDATE pokemons SET nome = ?, tipo_primario = ?, tipo_secundario = ?, nivel = ?, hp_maximo = ?, fk_treinador = ? WHERE id_pokemon = ?";
        try (Connection conn = ConexaoPostgresDB.conectar();
