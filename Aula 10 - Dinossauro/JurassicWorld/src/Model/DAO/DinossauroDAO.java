...
public class DinossauroDAO { // Sem interface
    ...
    public List<Dinossauro> listarTodos() {
        ...
        String sql = "SELECT id_dinossauro, nome, especie, dieta, idade_estimada_anos, idade_dinossauro, status_cercado FROM dinossauros ORDER BY nome";
        try (Connection conn = ConexaoPostgresDB.conectar();
    ...
    public Dinossauro buscarPorId(int idDinossauro) {
        String sql = "SELECT id_dinossauro, nome, especie, dieta, idade_estimada_anos, idade_dinossauro, status_cercado FROM dinossauros WHERE id_dinossauro = ?";
        try (Connection conn = ConexaoPostgresDB.conectar();
             PreparedStatement stmt = conn.prepareStatement(sql)) {
    ...
    public List<Dinossauro> buscarPorNome(String nomeBusca) {
        List<Dinossauro> dinossauros = new ArrayList<>();
        String sql = "SELECT id_dinossauro, nome, especie, dieta, idade_estimada_anos, idade_dinossauro, status_cercado FROM dinossauros WHERE nome ILIKE ? ORDER BY nome";
        try (Connection conn = ConexaoPostgresDB.conectar();
             PreparedStatement stmt = conn.prepareStatement(sql)) {
