...
public class TreinadorForm extends JInternalFrame {
    ...
    private void salvarTreinador() {
        try {
            ...
            controller.atualizarTreinador(new Treinador(treinadorIdParaEdicao, nome, cidade));
                JOptionPane.showMessageDialog(this, "Treinador atualizado com sucesso!");
            }
            this.dispose();
        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(this, "Nome ou Cidade inválidos. Por favor, insira valores válidos.", "Erro de Validação", JOptionPane.ERROR_MESSAGE);
