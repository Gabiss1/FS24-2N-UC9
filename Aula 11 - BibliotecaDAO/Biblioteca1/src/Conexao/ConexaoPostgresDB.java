...
public class ConexaoPostgresDB {
    ...
    public static void setAluno(String nome, int idade, String telefone) throws SQLException {
    ...
    public static void atualizarAluno(int id_aluno, String novoNome, int novaIdade, String novoTelefone) {
    ...
    if (testeConexao != null) {
        ...
        ConexaoPostgresDB.setAluno("Larissa", 29, "66667777");
        ConexaoPostgresDB.getAlunos();
        ConexaoPostgresDB.atualizarAluno(2,"Everton", 18, "51999876754");
